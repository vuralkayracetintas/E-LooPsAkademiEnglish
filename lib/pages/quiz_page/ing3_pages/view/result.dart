...
import '../../../decoration_pages/colors.dart';
import 'ing3_first_page.dart';

class Quiz3Result extends StatefulWidget {
  ...
  @override
  State<Quiz3Result> createState() => _Quiz3ResultState();
}

class _Quiz3ResultState extends State<Quiz3Result> {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ing3FirstPage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(

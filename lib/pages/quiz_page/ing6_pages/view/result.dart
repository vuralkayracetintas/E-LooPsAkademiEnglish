...
import 'package:ing_app_1502/pages/quiz_page/ing6_pages/view/ing6_first_page.dart';

class Quiz6Result extends StatefulWidget {
  ...
  @override
  State<Quiz6Result> createState() => _Quiz6ResultState();
}

class _Quiz6ResultState extends State<Quiz6Result> {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ing6FirstPage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(

...
class Ing6FirstPage extends StatefulWidget {
  const Ing6FirstPage({super.key});

  @override
  State<Ing6FirstPage> createState() => _Ing6FirstPageState();
}

class _Ing6FirstPageState extends State<Ing6FirstPage> {

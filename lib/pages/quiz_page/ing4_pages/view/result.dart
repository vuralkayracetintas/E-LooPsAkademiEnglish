...
import 'ing4_first_page.dart';

class Quiz4Result extends StatefulWidget {
  ...
  @override
  State<Quiz4Result> createState() => _Quiz4ResultState();
}

class _Quiz4ResultState extends State<Quiz4Result> {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ing4FirstPage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(

...
import 'package:ing_app_1502/pages/quiz_page/ing1_pages/view/play_quiz.dart';

class Ing1FirstPage extends StatefulWidget {
  const Ing1FirstPage({super.key});

  @override
  State<Ing1FirstPage> createState() => _Ing1FirstPageState();
}

class _Ing1FirstPageState extends State<Ing1FirstPage> {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ing1PlayQuiz(),
                  ),
                );
              },
              child: const Text(

...
import 'ing1_first_page.dart';

class Quiz1Result extends StatefulWidget {
  ...
  @override
  State<Quiz1Result> createState() => _Quiz1ResultState();
}

class _Quiz1ResultState extends State<Quiz1Result> {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ing1FirstPage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(

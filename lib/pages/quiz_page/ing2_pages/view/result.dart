...
import 'package:ing_app_1502/pages/quiz_page/ing2_pages/view/ing2_first_page.dart';

class Quiz2Result extends StatefulWidget {
  ...
  @override
  State<Quiz2Result> createState() => _Quiz2ResultState();
}

class _Quiz2ResultState extends State<Quiz2Result> {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ing2FirstPage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(

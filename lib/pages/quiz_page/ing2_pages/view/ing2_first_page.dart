...
class Ing2FirstPage extends StatefulWidget {
  const Ing2FirstPage({super.key});

  @override
  State<Ing2FirstPage> createState() => _Ing2FirstPageState();
}

class _Ing2FirstPageState extends State<Ing2FirstPage> {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ing2PlayQuiz(),
                  ),
                );
              },
              child: const Text(

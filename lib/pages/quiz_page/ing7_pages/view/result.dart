...
import 'package:ing_app_1502/pages/quiz_page/ing7_pages/view/ing7_first_page.dart';

class Quiz7Result extends StatefulWidget {
  ...
  @override
  State<Quiz7Result> createState() => _Quiz7ResultState();
}

class _Quiz7ResultState extends State<Quiz7Result> {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ing7FirstPage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(

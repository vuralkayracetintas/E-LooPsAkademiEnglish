...
import 'package:ing_app_1502/pages/quiz_page/ing6_pages/view/play_quiz.dart';
import 'package:ing_app_1502/pages/quiz_page/ing7_pages/view/play_quiz.dart';

class Ing7FirstPage extends StatefulWidget {
  const Ing7FirstPage({super.key});

  @override
  State<Ing7FirstPage> createState() => _Ing7FirstPageState();
}

class _Ing7FirstPageState extends State<Ing7FirstPage> {

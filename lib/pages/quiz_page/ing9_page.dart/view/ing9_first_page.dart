...
import 'package:ing_app_1502/pages/quiz_page/ing8_pages/view/play_quiz.dart';
import 'package:ing_app_1502/pages/quiz_page/ing9_page.dart/view/play_quiz.dart';

class Ing9FirstPage extends StatefulWidget {
  const Ing9FirstPage({super.key});

  @override
  State<Ing9FirstPage> createState() => _Ing9FirstPageState();
}

class _Ing9FirstPageState extends State<Ing9FirstPage> {

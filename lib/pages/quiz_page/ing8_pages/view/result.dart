...
import 'package:ing_app_1502/pages/quiz_page/ing8_pages/view/ing8_first_page.dart';

class Quiz8Result extends StatefulWidget {
  ...
  @override
  State<Quiz8Result> createState() => _Quiz8ResultState();
}

class _Quiz8ResultState extends State<Quiz8Result> {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Ing8FirstPage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(

...
import 'package:ing_app_1502/pages/bilinmesi_gereken_pages/page/bg3_page.dart';
import 'package:ing_app_1502/pages/decoration_pages/colors.dart';

class BG3Ui extends StatelessWidget {
  const BG3Ui({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const BG3Page()));
              },
              child: Padding(

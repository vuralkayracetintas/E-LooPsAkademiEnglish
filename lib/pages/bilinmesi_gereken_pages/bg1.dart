...
import 'package:ing_app_1502/pages/bilinmesi_gereken_pages/page/bg1_page.dart';
import 'package:ing_app_1502/pages/decoration_pages/colors.dart';

class BG1Ui extends StatelessWidget {
  const BG1Ui({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const BG1Page()));
              },
              child: Padding(

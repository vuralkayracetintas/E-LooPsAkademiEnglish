...
import 'package:ing_app_1502/pages/bilinmesi_gereken_pages/page/bg5_page.dart';
import 'package:ing_app_1502/pages/decoration_pages/colors.dart';

class BG5Ui extends StatelessWidget {
  const BG5Ui({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const BG5Page()));
              },
              child: Padding(

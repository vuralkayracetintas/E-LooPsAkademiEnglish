...
import 'package:ing_app_1502/pages/kisa_konular/kisa_konular_pages/kisa_konu3_page.dart';

class KisaKonu3Ui extends StatelessWidget {
  const KisaKonu3Ui({super.key});
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const KisaKonu3Page()));
              },
              child: Padding(
